		...
		<div class="content-wrapper">
					...
					<tbody>
						<c:forEach var="traveller" items="${orders.travellers}">
							...
							<tr>
								...
								<td><input type="text" size="20" value="${traveller.phoneNumber}" readonly="readonly"></td>
			...
			<div class="panel panel-default">
				...
				<div class="row data-type">
					...
					<div class="col-md-4 data text">${orders.member.emil}</div>
			...
			<!--费用信息-->
			<c:if test="${orders.orderStatue==1}">
				<div class="panel panel-default">
